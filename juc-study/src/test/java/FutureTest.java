...
public class FutureTest {
    ...
    /**
     * FutureTask则是一个RunnableFuture<V>， 即实现了Runnbale又实现了Futrue<V>这两个接口， 另外它还可以包装Runnable(实际上会转换为Callable)和Callable
    ...
    public static void testFutureTask() {
        ...
        FutureTask<Integer> futureTask =
                new FutureTask<Integer>(new Task2());
    ...
    public static void testFutureTask2() {
        ExecutorService executorService = Executors.newCachedThreadPool();
        FutureTask<Integer> futureTask =
                new FutureTask<Integer>(new Runnable() {
